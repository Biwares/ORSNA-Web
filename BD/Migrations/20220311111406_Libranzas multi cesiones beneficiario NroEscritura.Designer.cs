...
namespace BD.Migrations
{
    ...
    [Migration("20220311111406_Libranzas multi cesiones beneficiario NroEscritura")]
    partial class LibranzasmulticesionesbeneficiarioNroEscritura
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BD.Models.Destinos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("RequiereAeropuerto");
            ...
            modelBuilder.Entity("BD.Models.LibranzaAdjuntos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BD.Models.LibranzaBeneficiariosCesiones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("IdBeneficiarioBancosNavigationId");

                    b.Property<int?>("IdBeneficiarioNavigationId");

                    b.Property<int>("IdLibranzas");

                    b.Property<int?>("IdLibranzasNavigationId");
                    ...
                    b.HasIndex("IdBeneficiarioBancosNavigationId");

                    b.HasIndex("IdBeneficiarioNavigationId");

                    b.HasIndex("IdLibranzasNavigationId");

                    b.ToTable("LibranzaBeneficiariosCesiones");
                });
            ...
            modelBuilder.Entity("BD.Models.LibranzaDetalleWorkflow", b =>
                {
                    ...
                    b.Property<int?>("MonedaActualId");

                    b.Property<string>("Observaciones")
                        .IsRequired();

                    b.Property<decimal>("TasaDeCambioActual");
            ...
            modelBuilder.Entity("BD.Models.Libranzas", b =>
                {
                    ...
                    b.Property<string>("CesionCbu");

                    b.Property<string>("CesionCuit");

                    b.Property<DateTime?>("CesionFechaVigencia");

                    b.Property<string>("CesionNombreBanco");

                    b.Property<string>("CesionNroCuenta");

                    b.Property<string>("CesionSucursal");

                    b.Property<string>("CesionTipoCuenta");

                    b.Property<string>("CesionTitular");
                    ...
                    b.Property<string>("ObjetoDatosGenerales");
                    ...
                    b.Property<string>("RetencionObservaciones");
            ...
            modelBuilder.Entity("BD.Models.Moneda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BD.Models.Proyectos", b =>
                {
                    ...
                    b.Property<decimal?>("MontoPagadoAniosAnteriores");
                    ...
                    b.Property<bool?>("PagosImpuestosIncluidos");
            ...
            modelBuilder.Entity("BD.Models.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BD.Models.RolModulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BD.Models.UsuarioRol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BD.Models.LibranzaBeneficiariosCesiones", b =>
                {
                    b.HasOne("BD.Models.BeneficiarioBancos", "IdBeneficiarioBancosNavigation")
                        .WithMany()
                        .HasForeignKey("IdBeneficiarioBancosNavigationId");

                    b.HasOne("BD.Models.Beneficiarios", "IdBeneficiarioNavigation")
                        .WithMany()
                        .HasForeignKey("IdBeneficiarioNavigationId");

                    b.HasOne("BD.Models.Libranzas", "IdLibranzasNavigation")
                        .WithMany()
                        .HasForeignKey("IdLibranzasNavigationId");
                });
            ...
            modelBuilder.Entity("BD.Models.LibranzaDetalleWorkflow", b =>
                {
                    ...
                    b.HasOne("BD.Models.Moneda", "MonedaActual")
                        .WithMany()
                        .HasForeignKey("MonedaActualId");
                });
            ...
            modelBuilder.Entity("BD.Models.Libranzas", b =>
                {
                    ...
                    b.HasOne("BD.Models.Moneda", "Moneda")
                        .WithMany()
            ...
            modelBuilder.Entity("BD.Models.Proyectos", b =>
                {
                    b.HasOne("BD.Models.Destinos", "Destinos")
                        .WithMany()
            ...
            modelBuilder.Entity("BD.Models.RolModulo", b =>
                {
                    b.HasOne("BD.Models.Modulos", "Modulo")
                        .WithMany()
                        .HasForeignKey("IdModulo")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BD.Models.Rol", "Rol")
                        .WithMany("Modulos")
                        .HasForeignKey("IdRol")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("BD.Models.UsuarioRol", b =>
                {
                    ...
                    b.HasOne("BD.Models.Usuarios", "Usuario")
                        .WithMany("UsuarioRol")
