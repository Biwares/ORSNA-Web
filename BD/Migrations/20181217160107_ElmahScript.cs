...
{
    public partial class ElmahScript : Migration
    {
        ...
        {
                migrationBuilder.Sql(@"
                EXEC sp_MSForEachTable 'ALTER TABLE ELMAH_Error  NOCHECK CONSTRAINT ALL'
                EXEC sp_MSForEachTable 'DELETE FROM ELMAH_Error'
                EXEC sp_MSForEachTable 'ALTER TABLE ELMAH_Error CHECK CONSTRAINT ALL'
                ");
        }
    }
}
